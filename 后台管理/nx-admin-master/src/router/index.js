...
// import history from '@/views/table/complex-table3.vue'
...
export const constantRouterMap = [
  ...
  // { path: '', component:Layout,redirect: '/table/complex-table3'},
  ...
  // 用户
  {
    path: '/tableUse',
    component: Layout,
    redirect: '/tableUse/complex-table',
    name: 'tableUser',
    alwaysShow: true,
    meta: {
      title: '用户管理',
    ...
    children: [
      {
        path: 'complex-table',
        name: 'complex-table',
        component: () => import('@/views/tableUse/complex-table'),
        meta: { title: '用户列表' },
      },
    ]
  },
    ...
    children: [
      {
        path: 'editor',
        name: 'editor',
        component: () => import('@/views/tableUse/editor'),
        meta: { title: '文章浏览' },
      },
    ]
  },
    ...
    children: [
      {
        path: 'one',
        name: 'one',
        component: () => import('@/views/table/one'),
        meta: { title: '更多' },
      },
    ]
  },
  ...
  //   ]
  // }
  // {path:'complex-table3',component:history }
  // {path: '/table',component: history}
