     ...
     <error-log class="errLog-container right-menu-item"></error-log>
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
          <img class="user-avatar" src="https://img0.baidu.com/it/u=3509668989,3943717045&fm=253&fmt=auto&app=138&f=PNG?w=500&h=521">
...
// 退出
import { logout } from '@/api/userTable'
    ...
    logout() {
      this.$confirm('确认退出登录吗?', '提示', {
        ...
        .then(() => {
          ...
          // window.location.href = "http://localhost:1416/#/login";
      })
        })
