...
public class ConvertUtils {
    ...
    public static ErnieRequest chatErnieReqToErnieReq(ChatErnieRequest chatErnieRequest) {
        ...
        if (chatErnieRequest == null) {
            throw new BusinessException(com.gearwenxin.common.ErrorCode.PARAMS_ERROR);
        }
        ...
        if (chatErnieRequest.getContent() != null) {
            ...
            messageQueue.add(new Message(com.gearwenxin.common.RoleEnum.user, chatErnieRequest.getContent()));
